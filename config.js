...
const CONFIG = {
    ...
    // You can use emojis! 💝 💖 💗 💓 💞 💕
    pageTitle: "Vc quer ser minha macaquinha? 💝",
    ...
    questions: {
        ...
        second: {
            text: "O quanto você está boila?",                          // For the love meter
            startText: "Esse tanto!",                                   // Text before the percentage
            nextBtn: "Próximo ❤️"                                         // Text for the next button
        },
        third: {
            text: "Você quer ser minha Padmé? 🌹", // The big question!
            yesBtn: "Sim!",                                             // Text for "Yes" button
            noBtn: "Não"                                                 // Text for "No" button
        }
    },
    ...
    loveMessages: {
        extreme: "VC TA BOILAAAAAAA 🥰💝",  // Shows when they go past 5000%
    ...
    music: {
        ...
        musicUrl: "https://github.com/CamposEdu/dia-dos-namorados-2026/raw/refs/heads/main/Goo%20Goo%20Dolls%20-%20Iris%20-%20LatinHype%20(youtube).mp3", // Music streaming URL
